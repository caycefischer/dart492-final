(function() {
  ...
  Morris.Line = (function() {
        ...
        _results.push((function() {
          ...
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            ...
            if (c === null) {
              ...
              circle = this.r.circle(c.x, c.y, this.options.pointSize).attr('fill', this.options.lineColors[i]).attr('stroke-width', 1).attr('stroke', this.options.pointStroke);
            }
    ...
    Line.prototype.drawHover = function() {
      ...
      this.xLabel = this.r.text(0, (this.options.hoverFontSize * 0.75) - this.hoverHeight / 2, '').attr('fill', this.options.hoverLabelColor).attr('font-weight', 'normal').attr('font-size', this.options.hoverFontSize);
